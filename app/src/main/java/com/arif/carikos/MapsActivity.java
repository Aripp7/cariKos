...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final LatLng sma= new LatLng(-0.9265198495101721, 100.43365682666486);
        mMap.addMarker(new MarkerOptions().position(sma).title(id));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(sma));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(sma, INITIAL_ZOOM));
        enableMapStyles(googleMap);
        enableMyLocation();
        enableDropPin(googleMap);
        enableDynamicMarker();
    ...
    private  void enableDynamicMarker(){
        String URL = "http://carikos.mwebs.id/addmaker.php?key="+id;
                        ...
                        try{
                            ...
                            for(int i=0;i<result.length();i++){
                                ...
                                mMap.addMarker(new MarkerOptions()
                                        ...
                                        .snippet("ahsd"));
                                mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-0.1390238,100.5498191), 11.0f));
                            }
